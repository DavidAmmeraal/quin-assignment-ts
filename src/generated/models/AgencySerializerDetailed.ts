...
export type AgencySerializerDetailed = {
    readonly id?: number;
    readonly url?: string;
    name: string;
    featured?: boolean;
    ...
    readonly launcher_list?: Array<LauncherConfigDetailSerializerForAgency>;
    readonly spacecraft_list?: Array<SpacecraftConfigurationDetail>;
}
